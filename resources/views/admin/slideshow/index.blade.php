...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Tabel Slideshow</h2>
        <p class="mb-0">List Slideshow</p>
    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{route('slideshow.create')}}" class="btn btn-sm btn-success d-inline-flex align-items-center">
            <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
            </svg>
            Tambah Data Slideshow
        </a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img src="{{ asset('gambar/' . $slideshow->gambar_slideshow) }}" width="100px" alt="Gambar Product">
                    @else
                    Tidak Ada Foto
                    @endif
                </td>
                <td class="td-actions text-right">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('slideshow.edit', $slideshow->Id_slideshow) }}" class="btn btn-sm btn-warning">
                        ...
                        <form action="{{ route('slideshow.destroy', $slideshow->Id_slideshow) }}" method="POST" style="display:inline;" class="delete-form">
                            @csrf
...
<script>
    document.querySelectorAll('.delete-button').forEach(button => {
        button.addEventListener('click', function() {
            ...
            Swal.fire({
                title: 'Apakah anda yakin untuk menghapus slideshow ini?',
